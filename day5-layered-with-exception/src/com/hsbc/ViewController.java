...
import com.hsbc.factory.Factory;
	...
	public static void main(String[] args) {
		...
		do {
			...
			case 3:
				...
				break;
			case 4:
				System.out.println("Enter the id of the Employee for which you want to update the name :");
				...
				break;
			case 5:
				System.out.println("Enter the id of the Employee for which you want to update the Salary :");
